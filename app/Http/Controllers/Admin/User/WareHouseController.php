...
class WareHouseController extends Controller
{
     ...
     */
    protected $breadcrumb = ['Quản lý thành viên', 'quản lý kho'];
    ...
    public function create()
    {
        ...
        return view('admin.elements.users.warehouse.add', ['agency' => $agency, 'active' => 'warehouse', 'breadcrumb' => $this->breadcrumb]);
    }
...
//        Mail::to($request->email)->send(new ShipperMail($request->name, $uuid->uuid, $request->password));
        return redirect(url('admin/warehouse'))->with('success', 'Thêm mới quản lý kho thành công thành công');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.elements.users.warehouse.details', ['agency' => $agency, 'user' => $warehouse, 'active' => 'warehouse', 'breadcrumb' => $this->breadcrumb]);
    }
