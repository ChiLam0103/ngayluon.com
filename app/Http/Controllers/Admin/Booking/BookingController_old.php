...
class BookingController extends Controller
{
    ...
    public static function actionImportBooking($array){
        ...
        dd($shop,$shipper,$district);
       $booking= DB::table('bookings')->insert([
            'name'=>$array['ten_don_hang'],
            'uuid'=>$uuid,
            'sender_id'=>$shop->id,
            'send_phone'=>$shop->phone_number,
            'send_district_id'=>$shop->district_id,
            'send_full_address'=>$shop->home_number,
            'receive_name'=>$array['ten_kh'],
            'receive_phone'=>$array['sdt'],
            'receive_district_id'=>$district->id,
            'receive_full_address'=>$array['dia_chi'],
            'COD'=>$array['tien_thu'],
            'price'=>$array['tien_ship'],
            'COD'=>$array['tien_hang'],
