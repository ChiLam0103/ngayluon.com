...
{
    protected $breadcrumb = ['Quản lý liên hệ'];

    public function getContact()
    {
        $this->breadcrumb[] = 'danh sách';
        return view('admin.elements.feedback.contact', ['active' => 'contact', 'breadcrumb' => $this->breadcrumb]);
    }
    public function getSignin()
    {
        $this->breadcrumb[] = 'danh sách';
        return view('admin.elements.feedback.signin', ['active' => 'signin', 'breadcrumb' => $this->breadcrumb]);
    }
    public function getNewspaper()
    {
        $this->breadcrumb[] = 'danh sách';
        return view('admin.elements.feedback.newspaper', ['active' => 'newspaper', 'breadcrumb' => $this->breadcrumb]);
    }
