                    ...
                    <div class="collapse navbar-collapse" id="navbarColor01">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item {{isset($active) && $active == 'pending' ? 'active' : ''}}">
                                <a class="nav-link" href="{{ url('/front-ent/COD/pending') }}">Ngay & Luôn sắp chuyển đến bạn</a>
                            </li>
                            <li class="nav-item {{isset($active) && $active == 'finish' ? 'active' : ''}}">
                                <a class="nav-link" href="{{ url('/front-ent/COD/finish') }}">Ngay & Luôn đã chuyển đến bạn</a>
                            </li>
                        </ul>
                    </div>
                </nav>
