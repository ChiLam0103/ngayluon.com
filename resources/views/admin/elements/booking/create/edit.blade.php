                ...
                <div class="portlet-body form">
                    ...
                    <div class="row" style="margin-bottom: 15px">
                        <div class="{{-- has-error --}} form-group">
                            <div class="col-lg-6">
                                ...
                                <input name="phone_number_fr" value="{{ old('phone_number_fr', @$booking->send_phone) }}"
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            {{ Form::select('province_id_fr', \App\Models\Province::getProvinceOption(), old('province_id_fr', @$booking->send_province_id), ['class' => 'form-control', 'style' => 'width:100%', 'id' => 'province_fr', 'onchange' => 'loadDistrictFrom()']) }}
                        ...
                        <div class="col-lg-3">
                            ...
                            <select id="district_fr" name="district_id_fr" class="form-control">
                            </select>
                        ...
                        <div class="col-lg-3">
                            <label>Tỉnh/Thành phố</label>
                            {{ Form::select('province_id_to', \App\Models\Province::getProvinceOption(), old('province_id_to', @$booking->receive_province_id), ['class' => 'form-control', 'style' => 'width:100%', 'id' => 'province_to', 'onchange' => 'loadDistrictTo()']) }}
                        ...
                        <div class="col-lg-3">
                            <label>Quận/Huyện</label>
                            <select id="district_to" name="district_id_to" class="form-control">
                            </select>
                    ...
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input name="home_number_to" class="form-control spinner" type="text" onchange="searchPrice()"
                                value="{{ old('home_number_to', @$booking->receive_homenumber) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input class="form-control spinner" id="price"
                                    value="{{ old('price', @$booking->price) }}" name="price" type="text">
                                @if ($errors->has('price'))
                    ...
                    <button onclick="this.disabled=true; this.form.submit();" type="submit" class="btn blue">Thực
                        hiện</button>
        ...
        <div class="col-lg-2">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        <i class="fa fa-edit"></i>
                        <span class="caption-subject bold uppercase">Log đơn hàng</span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <div class="row">
        ...
        */
        ...
        function loadDistrictFrom(callback) {
            ...
            $.ajax({
                ...
                for (i = 0; i < msg.length; i++) {
                    if (msg[i]['id'] == '{{ @$booking->send_district_id }}' || msg[i]['id'] ==
                        '{{ @old('district_id_fr') }}') {
        ...
        function loadWardFrom(id, callback) {
            $.ajax({
                ...
                var i;
                for (i = 0; i < msg.length; i++) {
                    if (msg[i]['id'] == '{{ @$booking->send_ward_id }}' || msg[i]['id'] ==
                        '{{ @old('ward_id_fr') }}') {
                        $('select[name="ward_id_fr"]').append('<option value="' + msg[i]['id'] + '" selected>' +
                            msg[i]['name'] + '</option>')
                    } else {
                        $('select[name="ward_id_fr"]').append('<option value="' + msg[i]['id'] + '">' + msg[i][
                            'name'
                        ] + '</option>')
                    }
                }
        ...
        function loadDistrictTo(callback) {
            ...
            $.ajax({
                ...
                var i;
                for (i = 0; i < msg.length; i++) {
                    if (msg[i]['id'] == '{{ @$booking->receive_district_id }}' || msg[i]['id'] ==
                        '{{ @old('district_id_to') }}') {
        ...
        function loadWardTo(id, callback) {
            $.ajax({
                ...
                var i;
                for (i = 0; i < msg.length; i++) {
                    if (msg[i]['id'] == '{{ @$booking->receive_ward_id }}' || msg[i]['id'] ==
                        '{{ @old('ward_id_to') }}') {
                        $('select[name="ward_id_to"]').append('<option value="' + msg[i]['id'] + '" selected>' +
                            msg[i]['name'] + '</option>')
                    } else {
                        $('select[name="ward_id_to"]').append('<option value="' + msg[i]['id'] + '">' + msg[i][
                            'name'
                        ] + '</option>')
                    }
                }
