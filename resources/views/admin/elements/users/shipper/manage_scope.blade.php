                ...
                <div class="portlet-body form">
                    ...
                    <div class="row" style="margin-bottom: 20px">
                        <div class="col-md-12">
                            ...
                            <input type="checkbox" name="auto_receive" value="1" @if ($shipper->auto_receive == 1) checked="" @endif>
                            Cho phép tự lấy hàng &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="checkbox" name="auto_send" value="1" @if ($shipper->auto_send == 1) checked="" @endif> Cho
                            phép tự giao hàng
                        </div>
                    </div>
            ...
            function loadDistrict(provinceId) {
                ...
                if ($.inArray(provinceId, arrProvince) < 0) {
                    ...
                    $.ajax({
                        ...
                        var i;
                        for (i = 0; i < msg.length; i++) {
                            $('#scope').append('<option value="' + msg[i]['id'] + '" onclick="loadWard(' + msg[i][
                                'id'] + ')">' + msg[i]['name'] + '</option>')
                        }
                    });
                }
            }
            ...
            function loadWard(districtId) {
                if ($.inArray(districtId, arrDistrict) < 0) {
                    ...
                    $.ajax({
                        ...
                        var i;
                        for (i = 0; i < msg.length; i++) {
                            $('#ward_scope').append('<option value="' + msg[i]['id'] + '">' + msg[i]['name'] +
                                '</option>')
                        }
                    });
                }
